/**
 * Supabase database types — shared between web and mobile.
 *
 * Regenerate with:
 *   npx supabase gen types typescript --project-id YOUR_PROJECT_ID > apps/mobile/lib/database-types.ts
 */
  ...
  public: {
    Tables: {
      ...
      activity_posts: {
        ...
        Insert: Omit<Database['public']['Tables']['activity_posts']['Row'], 'id' | 'created_at' | 'updated_at'> & {
          id?: string;
          created_at?: string;
          updated_at?: string;
        };
        Update: Partial<Database['public']['Tables']['activity_posts']['Insert']>;
      };
      user_activities: {
        Row: {
          id: string;
