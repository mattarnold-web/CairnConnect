    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 mt-2">
              <span className="text-sm text-gray-500">{regionName}</span>
              {dateRange && (
                <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <Card hover={false}>
          ...
          <p className="text-xs text-gray-400">Total Trails</p>
        </Card>
        <Card hover={false}>
          <p className="font-display text-2xl text-canopy font-bold">
        ...
        <Card hover={false}>
          ...
          <p className="text-xs text-gray-400">Total Elevation Gain</p>
        </Card>
        ...
        <Card hover={false}>
          ...
          <p className="text-xs text-gray-400">Trip Days</p>
        </Card>
      </div>
