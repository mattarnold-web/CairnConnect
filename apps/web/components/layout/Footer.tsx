        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/explore" className="block text-sm text-gray-500 hover:text-gray-900 transition-colors">Map & Businesses</Link>
              <Link href="/explore?tab=trails" className="block text-sm text-gray-500 hover:text-gray-900 transition-colors">Trails</Link>
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/dashboard" className="block text-sm text-gray-500 hover:text-gray-900 transition-colors">Business Dashboard</Link>
              <Link href="/dashboard/upgrade" className="block text-sm text-gray-500 hover:text-gray-900 transition-colors">Spotlight Plans</Link>
              <span className="block text-sm text-gray-400">Claim Your Listing</span>
            </div>
          </div>

          {/* Support */}
          <div>
            <h4 className="font-display text-sm font-semibold text-gray-900 mb-3">Support</h4>
            <div className="space-y-2">
