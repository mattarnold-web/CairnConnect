  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center justify-center gap-4 pt-32 text-center px-4">
        <h1 className="font-display text-2xl font-bold text-gray-900">Business not found</h1>
        <p className="text-gray-500">We could not find a business matching that URL.</p>
        <Link
          href="/explore"
